...
def main() -> None:
    ...
    # Intentional: container listens on all interfaces, network isolation via Docker.
    uvicorn.run("jidou.main:app", host="0.0.0.0", port=8192, reload=settings.debug)  # nosec B104
