...
async def get_config() -> dict[str, Any]:
    ...
    return {
        ...
        "media_paths": {
            "tv": {
                "container": settings.local_tv_path,
                "host": settings.local_tv_host_path,
            },
            "anime": {
                "container": settings.local_anime_path,
                "host": settings.local_anime_host_path,
            },
            "movie": {
                "container": settings.local_movie_path,
                "host": settings.local_movie_host_path,
            },
        },
        "image_cache_backend": settings.image_cache_backend,
        "image_cache_host_path": settings.image_cache_host_path,
        "image_cache_expiration_enabled": settings.image_cache_expiration_enabled,
        "image_cache_retention_days": settings.image_cache_retention_days,
