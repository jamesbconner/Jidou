...
const DQ_CHECKS: DqCheck[] = [
  ...
  },
  {
    ...
    description: 'TV or anime show with no downloaded files ever matched to it — may be an unused library entry.',
    test: (s) => (s.media_type === 'tv' || s.content_type === 'anime') && s.matched_file_count === 0,
  },
]
